...
\newpage
\subsection*{Underyling asset Bitcoin}
\subsubsection*{What is Bitcoin?} 
Bitcoin is a digital currency that was created in 2009 by an unknown person using the alias Satoshi Nakamoto after the financial crisis of 2008. In order to understand Bitcoin I have to explain characteristics of fiat money \footnote{A form of money that is not backed by a physical asset, but by the government or central bank that issues it.}. 
