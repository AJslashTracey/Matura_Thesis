...
This thesis explores whether I can develop an autonomous trading algorithm that can generate me a consistent profit. To that end my thesis will cover the entire cycle, from researching, finding a strategy, and live trading algorithm results with real money on Bitcoin evaluating the results in the end.
