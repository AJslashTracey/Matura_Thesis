...
\begin{abstract}
    \begin{center}
        ...
        Shortly said humans aren't made to trade so why not let the computer do the work for us. In my Matura thesisiI will try to develop a trading strategy that can autonomously buy and sell Bitcoin with a profit while showhing why trading isn't a free money machine and that you should probably stick with something else if you want to make money and not lose your mind while doing so.
    \end{center}
\end{abstract}
\clearpage
...
Depending on timeframe there are still a lot inefficient prices from which individuals can make a profit from. I will try to act on short term inefficient with my trading algorithm because I only have about one month for the live test and it would not make sense to run an algorithm which hold a trade over weeks and takes a trade every two months. In addtion the initial idea I had was based on short term signals.
