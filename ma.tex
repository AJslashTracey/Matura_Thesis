...
\pagenumbering{roman}
\begin{abstract}
    This thesis investigates the development and implementation of an autonomous Bitcoin trading algorithm, addressing the challenges of human emotion and bias in trading.
    Starting from the observation that human emotion-based decision making prevents traders from acting on opportunities in the markets…
